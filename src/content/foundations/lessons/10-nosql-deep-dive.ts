    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "paragraph", text: "When embedding makes sense: embed data that is always accessed together." },
        {
          kind: "list",
          items: [
            { text: "Embed: user's addresses (always fetched with the user profile)", tone: "healthy" },
            { text: "Embed: order's items (always shown with the order)", tone: "healthy" },
            { text: "Embed: product's images (always shown with the product)", tone: "healthy" },
            { text: "Don't embed: order's user details (user data changes independently)", tone: "critical" },
            { text: "Don't embed: product's reviews (could be thousands, grows unbounded)", tone: "critical" },
            { text: "Don't embed: comment's author (author appears in many places)", tone: "critical" },
          ],
        },
        ...
        { kind: "paragraph", text: "When to use MongoDB:" },
        {
          kind: "list",
          items: [
            { text: "Product catalogs (phones have different specs than books)", tone: "healthy" },
            { text: "User profiles with nested data", tone: "healthy" },
            { text: "Content management (articles, blogs)", tone: "healthy" },
            { text: "Real-time analytics", tone: "healthy" },
            { text: "Prototyping (schema flexibility speeds development)", tone: "healthy" },
            { text: "Financial transactions (need ACID across documents)", tone: "critical" },
            { text: "Highly relational data (many-to-many relationships)", tone: "critical" },
            { text: "Complex reporting with many aggregations", tone: "critical" },
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "paragraph", text: "When to use Cassandra:" },
        {
          kind: "list",
          items: [
            { text: "Billions of writes per day", tone: "healthy" },
            { text: "Time-series data (logs, events, metrics)", tone: "healthy" },
            { text: "Activity feeds", tone: "healthy" },
            { text: "Multi-datacenter, globally distributed", tone: "healthy" },
            { text: "High availability is critical", tone: "healthy" },
            { text: "Simple, predictable query patterns", tone: "healthy" },
            { text: "Complex queries (no JOINs, limited WHERE)", tone: "critical" },
            { text: "ACID transactions across rows", tone: "critical" },
            { text: "Frequently changing query patterns", tone: "critical" },
            { text: "Small datasets (overkill)", tone: "critical" },
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        ...
        { kind: "paragraph", text: "When to use graph databases:" },
        {
          kind: "list",
          items: [
            { text: "Social networks (friend recommendations)", tone: "healthy" },
            { text: "Fraud detection (connected fraudster networks)", tone: "healthy" },
            { text: "Knowledge graphs (Google's search graph)", tone: "healthy" },
            { text: "Recommendation engines", tone: "healthy" },
            { text: "Network/infrastructure topology", tone: "healthy" },
            { text: "Simple data without complex relationships", tone: "critical" },
            { text: "High write throughput", tone: "critical" },
            { text: "Large-scale analytics", tone: "critical" },
          ],
        },
        {
          kind: "insight",
