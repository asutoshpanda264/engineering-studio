      ...
      blocks: [
        {
          kind: "timeline",
          steps: [
            { label: "Browser cache check", ms: 1, rangeLabel: "~1ms" },
            { label: "DNS resolution", ms: 70, rangeLabel: "~20-120ms" },
            { label: "TCP handshake", ms: 30, rangeLabel: "~10-50ms" },
            { label: "TLS handshake", ms: 30, rangeLabel: "~10-50ms" },
            { label: "HTTP request sent", ms: 1, rangeLabel: "~1ms" },
            { label: "Server processing", ms: 125, rangeLabel: "~50-200ms — this is YOUR code", tone: "signal" },
            { label: "Network transfer", ms: 55, rangeLabel: "~10-100ms" },
            { label: "Browser rendering", ms: 200, rangeLabel: "~100-300ms" },
          ],
        },
        {
          kind: "paragraph",
          text: "Total: ~200-900ms. Notice: server processing is often the biggest variable. That's what you control as a backend engineer.",
        },
      ],
    },
    {
