...
import { ArrowRight, Lightbulb, Search, Target, Timer } from "lucide-react";
...
/**
 * The hero + filter toolbar + scenario list — everything below the page
 * shell (`AppHeader`, background layers, the Problems/Interviews tab
 * switcher). Split out of `problems/page.tsx` so that shell can render
 * this or `InterviewQuestionsBody` behind the same tab switch (Sept 18
 * nav plan, item 1) without either body needing to know about the other.
 *
