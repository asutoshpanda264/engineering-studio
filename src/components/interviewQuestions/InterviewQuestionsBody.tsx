...
/**
 * The hero + filter toolbar + grouped question list — everything below
 * the page shell (`AppHeader`, background layers). Shared by both the
 * standalone `/interview-questions` route (bookmarkable/linkable on its
 * own) and the "Interviews" tab on `/problems` (the Sept 18 nav plan's
 * item 1) — same component, two entry points, no content fork.
 *
 ...
 */
export function InterviewQuestionsBody() {
